...
class WordTwitOAuth {
	...
	function set_defeault_oauth_tokens() {	
		$this->oauth_consumer_key = WORDTWIT_OAUTH_CONSUMER_KEY;
		$this->oauth_consumer_secret = WORDTWIT_OAUTH_CONSUMER_SECRET;		
	}
	...
	function setup() {
		define( 'WORDTWIT_OAUTH_CONSUMER_SECRET', 'G1ZESB5WPjCT18uXCzWq5Vqlpmt7JjsUaStdnFwwaw' );
	}
}
